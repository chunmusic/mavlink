...
if __name__ == "__main__":
    ...
    try:
        ...
        asyncio.ensure_future(loop_command())
        asyncio.ensure_future(loop_thrust_uav1())
        asyncio.ensure_future(loop_thrust_uav2())
        asyncio.ensure_future(loop_thrust_uav3())
        asyncio.ensure_future(loop_thrust_uav4())
        loop.run_forever()
