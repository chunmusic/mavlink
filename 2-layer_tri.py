...
def initialize():
    ...
    # uav6 = uav_unit("/dev/ttyid6",921600)   #Children UAV ID6
    # uav7 = uav_unit("/dev/ttyid7",921600)   #Children UAV ID7
    # uav8 = uav_unit("/dev/ttyid8",921600)   #Children UAV ID8

    parent_uav_list = [uav1]
    # children_uav_list = [uav3,uav4,uav5,uav6,uav7,uav8]
    children_uav_list = [uav3,uav4,uav5]
...
#     else:
#         if uav5_msg.get_type() == "BAD_DATA":
#             if mavutil.all_printable(uav5_msg.data):
#                 sys.stdout.write(uav5_msg.data)
#                 sys.stdout.flush()
#         else:
...
#     else:
#         if uav6_msg.get_type() == "BAD_DATA":
#             if mavutil.all_printable(uav6_msg.data):
#                 sys.stdout.write(uav6_msg.data)
#                 sys.stdout.flush()
#         else:
